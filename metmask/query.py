...
#     cid = next(nodecontents(docSum.getElementsByTagName("Id")))
#     if mm.debug:
#         print('cid:' + cid, end=' ')
...
#     res = []
#     if not any([x in KNOWNTABLES for x in un.getTables()]):
#         return (res)
...
#     searchResults = xml.dom.minidom.parse(urllib.request.urlopen(esUrl))
...
#     summaryResults = xml.dom.minidom.parse(urllib.request.urlopen(summaryUrl)).documentElement
